const ITEMS = [
  { label: 'Matchups', description: 'Notes and tips for every character matchup', icon: '⚔' },
  { label: 'Team Builder', description: 'Find the best duo for your playstyle', icon: '🤝' },
  { label: 'Okizeme', description: 'Post-knockdown setups by character and position', icon: '⚡' },
];
  ...
  return (
    <main className="min-h-screen">
      <div className="max-w-3xl mx-auto px-6 py-10">
        <h1 className="font-heading text-2xl font-bold mb-1" style={{ color: '#eeeef4' }}>Match Prep</h1>
        <p className="text-sm mb-8" style={{ color: '#7777aa' }}>Everything you need before you play</p>
