  ...
  return (
    <main className="min-h-screen">
      <div className="max-w-4xl mx-auto px-4 py-10">
        <h1 className="text-2xl font-bold mb-1" style={{ color: '#e0e0f0' }}>Roster</h1>
        <p className="text-sm mb-8" style={{ color: '#8888aa' }}>Select a character to view their combo list</p>
