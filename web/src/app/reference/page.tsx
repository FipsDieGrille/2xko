const ITEMS = [
  { label: 'Frame Data', description: 'Startup, active and recovery frames for every move' },
  { label: 'Punish Finder', description: 'Find the optimal punish for any situation' },
];
  ...
  return (
    <main className="min-h-screen">
      <div className="max-w-3xl mx-auto px-6 py-10">
        <h1 className="text-2xl font-bold mb-1" style={{ color: '#e0e0f0' }}>Reference</h1>
        <p className="text-sm mb-8" style={{ color: '#8888aa' }}>Raw data and lookup tools</p>
